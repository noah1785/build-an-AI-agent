...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Runs file in the working directory, executing the file",
    parameters=types.Schema(
        ...
        properties={
            "file_path": types.Schema(
                ...
                description="Path to the file which will be run by the function",
            ),
            "args": types.Schema(
                type=types.Type.ARRAY,
                description="Other parameters for the function",
